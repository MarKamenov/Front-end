var todosController = function() {
    function all(context) {
        ...
        data.todos.get().then(function(data) {
            todos = _.chain(data).groupBy(controllerHelpers.groupByCategory)
            ...
            context.$element().html(tmpl(todos));
            $('.todo-box').on('change', function(ev) {
