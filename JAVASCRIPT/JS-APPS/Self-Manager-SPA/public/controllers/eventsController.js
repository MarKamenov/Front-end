var eventsController = function() {
    function all(context) {
        ...
        data.events.get().then(function(res) {
            events = _.chain(res).map(controllerHelpers.fixDate).groupBy(controllerHelpers.groupByCategory).map(controllerHelpers.parseGroups).value();
            ...
            context.$element().html(tmpl(events));
        }).catch(function(err) {
